...
-- Далее пишем триггеры на добавление записи в каждой из вышеозвученных таблиц:
...
-- добавим в таблицу users несколько записей для проверки:

INSERT INTO users (name, birthday_at) VALUES
  ('Константин', '1994-01-05'),
  ('Елена', '1984-01-11');
